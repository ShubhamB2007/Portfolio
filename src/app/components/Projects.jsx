         ...
         <div className='lg:w-[40%] w-[345px] h-full flex flex-col gap-7 lg:items-center lg:right-0 relative right-4 lg:bottom-0 bottom-11'>
             ...
             className='lg:w-[95%] w-full h-[50%] flex flex-col gap-1'>
                 <div className='mt-2 cursor-pointer group'>
                  ...
                  <button className="absolute inset-0 m-auto w-fit h-fit px-6 py-2 mt-24 ml-[165px] bg-[#f1f1f1] text-black font-semibold rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 cursor-pointer">
           ...
           className='lg:w-[95%] w-full h-[50%] flex flex-col gap-1'>
              <div className='mt-0 cursor-pointer group'>
                ...
                <button className="absolute inset-0 m-auto w-fit h-fit px-6 py-2 mb-40 ml-[165px] bg-[#f1f1f1] text-black font-semibold rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 cursor-pointer">
